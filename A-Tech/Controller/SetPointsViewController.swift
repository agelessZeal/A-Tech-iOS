...
class SetPointsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    
    @IBOutlet weak var previousBtn: UIButton!
    @IBOutlet weak var homeBtn: UIButton!
    @IBOutlet weak var nextBtn: UIButton!
    @IBOutlet weak var sortBtn: UIButton!
    @IBOutlet weak var setpointTableView: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.setpointTableView.dequeueReusableCell(withIdentifier: "setpointCell", for: indexPath)
        return cell
    }
