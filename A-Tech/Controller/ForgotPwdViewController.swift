...
class ForgotPwdViewController: UIViewController {
    ...
    func initForgotPwdView() {
        
        // Button UI...
        submitBtn.layer.cornerRadius = submitBtn.bounds.height / 2
        submitBtn.clipsToBounds = true
        
        cancelBtn.layer.cornerRadius = submitBtn.bounds.height / 2
        cancelBtn.clipsToBounds = true
    }
    
    @IBAction func onClickSubmitBtn(_ sender: UIButton) {
        
        let url = URL(string: "http://3.24.138.90:8081/api/v2/user/newPassword")
        ...
        let parameters : [String: Any] = [
            ...
            "newPassword": newpwdTextField.text ?? "",
